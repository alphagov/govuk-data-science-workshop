# Intro workshop about GOV.UK data science documentation build configuration file
#
...
project = "Intro workshop about GOV.UK data science"
author = "alphagov"
...
htmlhelp_basename = "govuk-data-science-workshopdoc"
